	...
	public DbSet<StudentToCourse> StudentToCourse { get; set; }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer(
                //Nome da conexão da maquina
                "Data Source=DESKTOP-O9CABQT\\SQLEXPRESS;" +
                //Nome do banco
                "Initial Catalog=dbSqlConnection;" +
                //Credenciais da conta atual do Windows são usadas para autenticação
